...
--
-- Host: localhost
-- Generation Time: Mar 16, 2016 at 09:01 AM
...
--
-- Table structure for table `pby9p_assets`
--

CREATE TABLE IF NOT EXISTS `pby9p_assets` (
...
--
-- Dumping data for table `pby9p_assets`
--

INSERT INTO `pby9p_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `pby9p_associations`
--

CREATE TABLE IF NOT EXISTS `pby9p_associations` (
...
--
-- Table structure for table `pby9p_banners`
--

CREATE TABLE IF NOT EXISTS `pby9p_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `pby9p_banner_clients`
--

CREATE TABLE IF NOT EXISTS `pby9p_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `pby9p_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `pby9p_banner_tracks` (
...
--
-- Table structure for table `pby9p_categories`
--

CREATE TABLE IF NOT EXISTS `pby9p_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `pby9p_categories`
--

INSERT INTO `pby9p_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `pby9p_contact_details`
--

CREATE TABLE IF NOT EXISTS `pby9p_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `pby9p_content`
--

CREATE TABLE IF NOT EXISTS `pby9p_content` (
...
--
-- Table structure for table `pby9p_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `pby9p_contentitem_tag_map` (
...
--
-- Table structure for table `pby9p_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `pby9p_content_frontpage` (
...
--
-- Table structure for table `pby9p_content_rating`
--

CREATE TABLE IF NOT EXISTS `pby9p_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `pby9p_content_types`
--

CREATE TABLE IF NOT EXISTS `pby9p_content_types` (
...
--
-- Dumping data for table `pby9p_content_types`
--

INSERT INTO `pby9p_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `pby9p_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `pby9p_core_log_searches` (
...
--
-- Table structure for table `pby9p_extensions`
--

CREATE TABLE IF NOT EXISTS `pby9p_extensions` (
...
--
-- Dumping data for table `pby9p_extensions`
--

INSERT INTO `pby9p_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"f6e0cd49b1ed7d2ac0b18072aec72dfd"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `pby9p_finder_filters`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_filters` (
...
--
-- Table structure for table `pby9p_finder_links`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links` (
...
--
-- Table structure for table `pby9p_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `pby9p_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `pby9p_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `pby9p_finder_taxonomy`
--

INSERT INTO `pby9p_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `pby9p_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `pby9p_finder_terms`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_terms` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `pby9p_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `pby9p_finder_terms_common`
--

INSERT INTO `pby9p_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `pby9p_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `pby9p_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `pby9p_finder_types`
--

CREATE TABLE IF NOT EXISTS `pby9p_finder_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `pby9p_languages`
--

CREATE TABLE IF NOT EXISTS `pby9p_languages` (
...
--
-- Dumping data for table `pby9p_languages`
--

INSERT INTO `pby9p_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `pby9p_menu`
--

CREATE TABLE IF NOT EXISTS `pby9p_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `pby9p_menu`
--

INSERT INTO `pby9p_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(22, 'menu', 'com_joomlaupdate', 'Joomla! Update', '', 'Joomla! Update', 'index.php?option=com_joomlaupdate', 'component', 1, 1, 1, 28, 0, '0000-00-00 00:00:00', 0, 0, 'class:joomlaupdate', 0, '', 35, 36, 0, '*', 1),
(23, 'main', 'com_tags', 'Tags', '', 'Tags', 'index.php?option=com_tags', 'component', 0, 1, 1, 29, 0, '0000-00-00 00:00:00', 0, 1, 'class:tags', 0, '', 37, 38, 0, '', 1),
(24, 'main', 'com_postinstall', 'Post-installation messages', '', 'Post-installation messages', 'index.php?option=com_postinstall', 'component', 0, 1, 1, 32, 0, '0000-00-00 00:00:00', 0, 1, 'class:postinstall', 0, '', 39, 40, 0, '*', 1),
...
(102, 'main', 'com_weblinks', 'com-weblinks', '', 'com-weblinks', 'index.php?option=com_weblinks', 'component', 0, 1, 1, 21, 0, '0000-00-00 00:00:00', 0, 1, 'class:weblinks', 0, '{}', 43, 48, 0, '', 1),
(103, 'main', 'com_weblinks_links', 'com-weblinks-links', '', 'com-weblinks/com-weblinks-links', 'index.php?option=com_weblinks', 'component', 0, 102, 2, 21, 0, '0000-00-00 00:00:00', 0, 1, 'class:weblinks', 0, '{}', 44, 45, 0, '', 1),
(104, 'main', 'com_weblinks_categories', 'com-weblinks-categories', '', 'com-weblinks/com-weblinks-categories', 'index.php?option=com_categories&extension=com_weblinks', 'component', 0, 102, 2, 21, 0, '0000-00-00 00:00:00', 0, 1, 'class:weblinks-cat', 0, '{}', 46, 47, 0, '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `pby9p_menu_types`
--

CREATE TABLE IF NOT EXISTS `pby9p_menu_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `pby9p_menu_types`
--

INSERT INTO `pby9p_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `pby9p_messages`
--

CREATE TABLE IF NOT EXISTS `pby9p_messages` (
...
--
-- Table structure for table `pby9p_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `pby9p_messages_cfg` (
...
--
-- Table structure for table `pby9p_modules`
--

CREATE TABLE IF NOT EXISTS `pby9p_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `pby9p_modules`
--

INSERT INTO `pby9p_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `pby9p_modules_menu`
--

CREATE TABLE IF NOT EXISTS `pby9p_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `pby9p_modules_menu`
--

INSERT INTO `pby9p_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `pby9p_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `pby9p_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `pby9p_overrider`
--

CREATE TABLE IF NOT EXISTS `pby9p_overrider` (
...
--
-- Table structure for table `pby9p_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `pby9p_postinstall_messages` (
...
--
-- Dumping data for table `pby9p_postinstall_messages`
--

INSERT INTO `pby9p_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `pby9p_redirect_links`
--

CREATE TABLE IF NOT EXISTS `pby9p_redirect_links` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `pby9p_schemas`
--

CREATE TABLE IF NOT EXISTS `pby9p_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `pby9p_schemas`
--

INSERT INTO `pby9p_schemas` (`extension_id`, `version_id`) VALUES
(21, '3.4.0'),
...
--
-- Table structure for table `pby9p_session`
--

CREATE TABLE IF NOT EXISTS `pby9p_session` (
...
--
-- Dumping data for table `pby9p_session`
--

INSERT INTO `pby9p_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('ue5cdhf7doroa9qiro9djtdpt2', 1, 0, '1458118395', 'joomla|s:2244:"";', 808, 'admin');

-- --------------------------------------------------------

--
-- Table structure for table `pby9p_tags`
--

CREATE TABLE IF NOT EXISTS `pby9p_tags` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `pby9p_tags`
--

INSERT INTO `pby9p_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `pby9p_template_styles`
--

CREATE TABLE IF NOT EXISTS `pby9p_template_styles` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `pby9p_template_styles`
--

INSERT INTO `pby9p_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `pby9p_ucm_base`
--

CREATE TABLE IF NOT EXISTS `pby9p_ucm_base` (
...
--
-- Table structure for table `pby9p_ucm_content`
--

CREATE TABLE IF NOT EXISTS `pby9p_ucm_content` (
...
--
-- Table structure for table `pby9p_ucm_history`
--

CREATE TABLE IF NOT EXISTS `pby9p_ucm_history` (
...
--
-- Table structure for table `pby9p_updates`
--

CREATE TABLE IF NOT EXISTS `pby9p_updates` (
...
--
-- Dumping data for table `pby9p_updates`
--

INSERT INTO `pby9p_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(5, 3, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '3.4.8.2', '', 'http://update.joomla.org/language/details3/nl-BE_details.xml', '', ''),
(6, 3, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', '', ''),
(7, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', '', ''),
(8, 3, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '3.3.1.2', '', 'http://update.joomla.org/language/details3/gl-ES_details.xml', '', ''),
(9, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(10, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/el-GR_details.xml', '', ''),
(11, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', '', ''),
(12, 3, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/he-IL_details.xml', '', ''),
(13, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', '', ''),
(14, 3, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.4.5.1', '', 'http://update.joomla.org/language/details3/af-ZA_details.xml', '', ''),
(15, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', '', ''),
...
(20, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.4.4.2', '', 'http://update.joomla.org/language/details3/hr-HR_details.xml', '', ''),
(21, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(22, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(23, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
(24, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
...
(34, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.4.5.1', '', 'http://update.joomla.org/language/details3/pt-PT_details.xml', '', ''),
(35, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(36, 3, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/en-AU_details.xml', '', ''),
(37, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.4.8.2', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(38, 3, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.4.6.1', '', 'http://update.joomla.org/language/details3/en-US_details.xml', '', ''),
...
(48, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(49, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(50, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(51, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
...
(56, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(57, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(58, 3, 0, 'English CA', '', 'pkg_en-CA', 'package', '', 0, '3.4.6.1', '', 'http://update.joomla.org/language/details3/en-CA_details.xml', '', ''),
(59, 3, 0, 'French CA', '', 'pkg_fr-CA', 'package', '', 0, '3.4.4.3', '', 'http://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
...
(63, 3, 0, 'Turkmen', '', 'pkg_tk-TM', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/tk-TM_details.xml', '', ''),
(64, 3, 0, 'Irish', '', 'pkg_ga-IE', 'package', '', 0, '3.4.8.1', '', 'http://update.joomla.org/language/details3/ga-IE_details.xml', '', ''),
(65, 3, 0, 'Dzongkha', '', 'pkg_dz-BT', 'package', '', 0, '3.4.5.1', '', 'http://update.joomla.org/language/details3/dz-BT_details.xml', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `pby9p_update_sites`
--

CREATE TABLE IF NOT EXISTS `pby9p_update_sites` (
...
--
-- Dumping data for table `pby9p_update_sites`
--

INSERT INTO `pby9p_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1458118395, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1458118275, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1458118275, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1458118275, ''),
(5, 'Weblinks Update Site', 'extension', 'https://raw.githubusercontent.com/joomla-extensions/weblinks/master/manifest.xml', 1, 1458118275, '');

-- --------------------------------------------------------

--
-- Table structure for table `pby9p_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `pby9p_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';

--
-- Dumping data for table `pby9p_update_sites_extensions`
--

INSERT INTO `pby9p_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28),
...
--
-- Table structure for table `pby9p_usergroups`
--

CREATE TABLE IF NOT EXISTS `pby9p_usergroups` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `pby9p_usergroups`
--

INSERT INTO `pby9p_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `pby9p_users`
--

CREATE TABLE IF NOT EXISTS `pby9p_users` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `pby9p_users`
--

INSERT INTO `pby9p_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(808, 'Super User', 'admin', 'vl@jelastic.com', '$2y$10$g3V55TJj0jdaLFnCfaA8KeCUSgvsAN3ppuD4exLXXZyEAsrqCjrgO', 0, 1, '2014-11-24 14:01:10', '2016-03-16 08:53:09', '0', '{}', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `pby9p_user_keys`
--

CREATE TABLE IF NOT EXISTS `pby9p_user_keys` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `pby9p_user_notes`
--

CREATE TABLE IF NOT EXISTS `pby9p_user_notes` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `pby9p_user_profiles`
--

CREATE TABLE IF NOT EXISTS `pby9p_user_profiles` (
...
--
-- Table structure for table `pby9p_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `pby9p_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `pby9p_user_usergroup_map`
--

INSERT INTO `pby9p_user_usergroup_map` (`user_id`, `group_id`) VALUES
(808, 8);

-- --------------------------------------------------------

--
-- Table structure for table `pby9p_viewlevels`
--

CREATE TABLE IF NOT EXISTS `pby9p_viewlevels` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `pby9p_viewlevels`
--

INSERT INTO `pby9p_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `pby9p_weblinks`
--

CREATE TABLE IF NOT EXISTS `pby9p_weblinks` (
  `id` int(10) unsigned NOT NULL,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Indexes for table `pby9p_assets`
--
ALTER TABLE `pby9p_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pby9p_associations`
--
ALTER TABLE `pby9p_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `pby9p_banners`
--
ALTER TABLE `pby9p_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pby9p_banner_clients`
--
ALTER TABLE `pby9p_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`);

--
-- Indexes for table `pby9p_banner_tracks`
--
ALTER TABLE `pby9p_banner_tracks`
...
--
-- Indexes for table `pby9p_categories`
--
ALTER TABLE `pby9p_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pby9p_contact_details`
--
ALTER TABLE `pby9p_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `pby9p_content`
--
ALTER TABLE `pby9p_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indexes for table `pby9p_contentitem_tag_map`
--
ALTER TABLE `pby9p_contentitem_tag_map`
...
--
-- Indexes for table `pby9p_content_frontpage`
--
ALTER TABLE `pby9p_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `pby9p_content_rating`
--
ALTER TABLE `pby9p_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `pby9p_content_types`
--
ALTER TABLE `pby9p_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`);

--
-- Indexes for table `pby9p_extensions`
--
ALTER TABLE `pby9p_extensions`
...
--
-- Indexes for table `pby9p_finder_filters`
--
ALTER TABLE `pby9p_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `pby9p_finder_links`
--
ALTER TABLE `pby9p_finder_links`
...
--
-- Indexes for table `pby9p_finder_links_terms0`
--
ALTER TABLE `pby9p_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_terms1`
--
ALTER TABLE `pby9p_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_terms2`
--
ALTER TABLE `pby9p_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_terms3`
--
ALTER TABLE `pby9p_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_terms4`
--
ALTER TABLE `pby9p_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_terms5`
--
ALTER TABLE `pby9p_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_terms6`
--
ALTER TABLE `pby9p_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_terms7`
--
ALTER TABLE `pby9p_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_terms8`
--
ALTER TABLE `pby9p_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_terms9`
--
ALTER TABLE `pby9p_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_termsa`
--
ALTER TABLE `pby9p_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_termsb`
--
ALTER TABLE `pby9p_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_termsc`
--
ALTER TABLE `pby9p_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_termsd`
--
ALTER TABLE `pby9p_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_termse`
--
ALTER TABLE `pby9p_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_links_termsf`
--
ALTER TABLE `pby9p_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `pby9p_finder_taxonomy`
--
ALTER TABLE `pby9p_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pby9p_finder_taxonomy_map`
--
ALTER TABLE `pby9p_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `pby9p_finder_terms`
--
ALTER TABLE `pby9p_finder_terms`
...
--
-- Indexes for table `pby9p_finder_terms_common`
--
ALTER TABLE `pby9p_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `pby9p_finder_tokens`
--
ALTER TABLE `pby9p_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `pby9p_finder_tokens_aggregate`
--
ALTER TABLE `pby9p_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `pby9p_finder_types`
--
ALTER TABLE `pby9p_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `pby9p_languages`
--
ALTER TABLE `pby9p_languages`
...
--
-- Indexes for table `pby9p_menu`
--
ALTER TABLE `pby9p_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pby9p_menu_types`
--
ALTER TABLE `pby9p_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `pby9p_messages`
--
ALTER TABLE `pby9p_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `pby9p_messages_cfg`
--
ALTER TABLE `pby9p_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `pby9p_modules`
--
ALTER TABLE `pby9p_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pby9p_modules_menu`
--
ALTER TABLE `pby9p_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `pby9p_newsfeeds`
--
ALTER TABLE `pby9p_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `pby9p_overrider`
--
ALTER TABLE `pby9p_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pby9p_postinstall_messages`
--
ALTER TABLE `pby9p_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `pby9p_redirect_links`
--
ALTER TABLE `pby9p_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_link_old` (`old_url`),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `pby9p_schemas`
--
ALTER TABLE `pby9p_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `pby9p_session`
--
ALTER TABLE `pby9p_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `pby9p_tags`
--
ALTER TABLE `pby9p_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pby9p_template_styles`
--
ALTER TABLE `pby9p_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `pby9p_ucm_base`
--
ALTER TABLE `pby9p_ucm_base`
...
--
-- Indexes for table `pby9p_ucm_content`
--
ALTER TABLE `pby9p_ucm_content`
...
--
-- Indexes for table `pby9p_ucm_history`
--
ALTER TABLE `pby9p_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `pby9p_updates`
--
ALTER TABLE `pby9p_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `pby9p_update_sites`
--
ALTER TABLE `pby9p_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `pby9p_update_sites_extensions`
--
ALTER TABLE `pby9p_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `pby9p_usergroups`
--
ALTER TABLE `pby9p_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pby9p_users`
--
ALTER TABLE `pby9p_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pby9p_user_keys`
--
ALTER TABLE `pby9p_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pby9p_user_notes`
--
ALTER TABLE `pby9p_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `pby9p_user_profiles`
--
ALTER TABLE `pby9p_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `pby9p_user_usergroup_map`
--
ALTER TABLE `pby9p_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `pby9p_viewlevels`
--
ALTER TABLE `pby9p_viewlevels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_assetgroup_title_lookup` (`title`);

--
-- Indexes for table `pby9p_weblinks`
--
ALTER TABLE `pby9p_weblinks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- AUTO_INCREMENT for table `pby9p_assets`
--
ALTER TABLE `pby9p_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT for table `pby9p_banners`
--
ALTER TABLE `pby9p_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_banner_clients`
--
ALTER TABLE `pby9p_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_categories`
--
ALTER TABLE `pby9p_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `pby9p_contact_details`
--
ALTER TABLE `pby9p_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_content`
--
ALTER TABLE `pby9p_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_content_types`
--
ALTER TABLE `pby9p_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `pby9p_extensions`
--
ALTER TABLE `pby9p_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `pby9p_finder_filters`
--
ALTER TABLE `pby9p_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_finder_links`
--
ALTER TABLE `pby9p_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_finder_taxonomy`
--
ALTER TABLE `pby9p_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `pby9p_finder_terms`
--
ALTER TABLE `pby9p_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_finder_types`
--
ALTER TABLE `pby9p_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_languages`
--
ALTER TABLE `pby9p_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `pby9p_menu`
--
ALTER TABLE `pby9p_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=105;
--
-- AUTO_INCREMENT for table `pby9p_menu_types`
--
ALTER TABLE `pby9p_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `pby9p_messages`
--
ALTER TABLE `pby9p_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_modules`
--
ALTER TABLE `pby9p_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `pby9p_newsfeeds`
--
ALTER TABLE `pby9p_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_overrider`
--
ALTER TABLE `pby9p_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `pby9p_postinstall_messages`
--
ALTER TABLE `pby9p_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `pby9p_redirect_links`
--
ALTER TABLE `pby9p_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_tags`
--
ALTER TABLE `pby9p_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `pby9p_template_styles`
--
ALTER TABLE `pby9p_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `pby9p_ucm_content`
--
ALTER TABLE `pby9p_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_ucm_history`
--
ALTER TABLE `pby9p_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_updates`
--
ALTER TABLE `pby9p_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=66;
--
-- AUTO_INCREMENT for table `pby9p_update_sites`
--
ALTER TABLE `pby9p_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `pby9p_usergroups`
--
ALTER TABLE `pby9p_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `pby9p_users`
--
ALTER TABLE `pby9p_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=809;
--
-- AUTO_INCREMENT for table `pby9p_user_keys`
--
ALTER TABLE `pby9p_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_user_notes`
--
ALTER TABLE `pby9p_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pby9p_viewlevels`
--
ALTER TABLE `pby9p_viewlevels`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `pby9p_weblinks`
--
ALTER TABLE `pby9p_weblinks`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
