...
--
-- Хост: localhost
-- Время создания: Апр 23 2019 г., 07:03
...
--
-- Структура таблицы `pby9p_action_logs`
--

CREATE TABLE `pby9p_action_logs` (
...
--
-- Дамп данных таблицы `pby9p_action_logs`
--

INSERT INTO `pby9p_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGIN_FAILED', '{\"action\":\"login\",\"id\":\"734\",\"userid\":\"734\",\"username\":\"jelastic\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=734\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-04-23 07:00:26', 'com_users', 734, 734, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_ACTIONLOG_JOOMLA_USER_LOGIN_FAILED', '{\"action\":\"login\",\"id\":\"734\",\"userid\":\"734\",\"username\":\"jelastic\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=734\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-04-23 07:01:25', 'com_users', 734, 734, 'COM_ACTIONLOGS_DISABLED'),
(3, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"734\",\"username\":\"jelastic\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=734\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-04-23 07:01:32', 'com_users', 734, 0, 'COM_ACTIONLOGS_DISABLED'),
(4, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{\"action\":\"logout\",\"id\":\"734\",\"userid\":\"734\",\"username\":\"jelastic\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=734\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-04-23 07:01:36', 'com_users', 734, 734, 'COM_ACTIONLOGS_DISABLED'),
(5, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"734\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=734\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-04-23 07:01:45', 'com_users', 734, 0, 'COM_ACTIONLOGS_DISABLED'),
(6, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{\"action\":\"logout\",\"id\":\"734\",\"userid\":\"734\",\"username\":\"admin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=734\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-04-23 07:01:56', 'com_users', 734, 734, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Структура таблицы `pby9p_action_logs_extensions`
--

CREATE TABLE `pby9p_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `pby9p_action_logs_extensions`
--

INSERT INTO `pby9p_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Структура таблицы `pby9p_action_logs_users`
--

CREATE TABLE `pby9p_action_logs_users` (
...
--
-- Структура таблицы `pby9p_action_log_config`
--

CREATE TABLE `pby9p_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `pby9p_action_log_config`
--

INSERT INTO `pby9p_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Структура таблицы `pby9p_assets`
--

CREATE TABLE `pby9p_assets` (
...
--
-- Дамп данных таблицы `pby9p_assets`
--
...
--
-- Структура таблицы `pby9p_associations`
--

CREATE TABLE `pby9p_associations` (
...
--
-- Структура таблицы `pby9p_banners`
--

CREATE TABLE `pby9p_banners` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `pby9p_banner_clients`
--

CREATE TABLE `pby9p_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `pby9p_banner_tracks`
--

CREATE TABLE `pby9p_banner_tracks` (
...
--
-- Структура таблицы `pby9p_categories`
--

CREATE TABLE `pby9p_categories` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `pby9p_categories`
--
...
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 734, '2019-04-23 06:33:25', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 734, '2019-04-23 06:33:25', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 734, '2019-04-23 06:33:25', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 734, '2019-04-23 06:33:25', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 734, '2019-04-23 06:33:25', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 734, '2019-04-23 06:33:25', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Структура таблицы `pby9p_contact_details`
--

CREATE TABLE `pby9p_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `pby9p_content`
--

CREATE TABLE `pby9p_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `pby9p_contentitem_tag_map`
--

CREATE TABLE `pby9p_contentitem_tag_map` (
  `type_alias` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `pby9p_content_frontpage`
--

CREATE TABLE `pby9p_content_frontpage` (
...
--
-- Структура таблицы `pby9p_content_rating`
--

CREATE TABLE `pby9p_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `pby9p_content_types`
--

CREATE TABLE `pby9p_content_types` (
...
--
-- Дамп данных таблицы `pby9p_content_types`
--
...
--
-- Структура таблицы `pby9p_core_log_searches`
--

CREATE TABLE `pby9p_core_log_searches` (
...
--
-- Структура таблицы `pby9p_extensions`
--

CREATE TABLE `pby9p_extensions` (
...
--
-- Дамп данных таблицы `pby9p_extensions`
--

INSERT INTO `pby9p_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2019 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"3bf1b2e0f5a45732b49e224d785b7c27\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2019 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1556001733}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Структура таблицы `pby9p_fields`
--

CREATE TABLE `pby9p_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `pby9p_fields_categories`
--

CREATE TABLE `pby9p_fields_categories` (
...
--
-- Структура таблицы `pby9p_fields_groups`
--

CREATE TABLE `pby9p_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `pby9p_fields_values`
--

CREATE TABLE `pby9p_fields_values` (
...
--
-- Структура таблицы `pby9p_finder_filters`
--

CREATE TABLE `pby9p_finder_filters` (
...
--
-- Структура таблицы `pby9p_finder_links`
--

CREATE TABLE `pby9p_finder_links` (
...
--
-- Структура таблицы `pby9p_finder_links_terms0`
--

CREATE TABLE `pby9p_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `pby9p_finder_links_terms1`
--

CREATE TABLE `pby9p_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_terms2`
--

CREATE TABLE `pby9p_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_terms3`
--

CREATE TABLE `pby9p_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_terms4`
--

CREATE TABLE `pby9p_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_terms5`
--

CREATE TABLE `pby9p_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_terms6`
--

CREATE TABLE `pby9p_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_terms7`
--

CREATE TABLE `pby9p_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_terms8`
--

CREATE TABLE `pby9p_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_terms9`
--

CREATE TABLE `pby9p_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_termsa`
--

CREATE TABLE `pby9p_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_termsb`
--

CREATE TABLE `pby9p_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_termsc`
--

CREATE TABLE `pby9p_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_termsd`
--

CREATE TABLE `pby9p_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_termse`
--

CREATE TABLE `pby9p_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_links_termsf`
--

CREATE TABLE `pby9p_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Структура таблицы `pby9p_finder_taxonomy`
--

CREATE TABLE `pby9p_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Дамп данных таблицы `pby9p_finder_taxonomy`
--
...
--
-- Структура таблицы `pby9p_finder_taxonomy_map`
--

CREATE TABLE `pby9p_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `pby9p_finder_terms`
--

CREATE TABLE `pby9p_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `pby9p_finder_terms_common`
--

CREATE TABLE `pby9p_finder_terms_common` (
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `language` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Дамп данных таблицы `pby9p_finder_terms_common`
--
...
--
-- Структура таблицы `pby9p_finder_tokens`
--

CREATE TABLE `pby9p_finder_tokens` (
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `pby9p_finder_tokens_aggregate`
--

CREATE TABLE `pby9p_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `pby9p_finder_types`
--

CREATE TABLE `pby9p_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `pby9p_languages`
--

CREATE TABLE `pby9p_languages` (
...
--
-- Дамп данных таблицы `pby9p_languages`
--

INSERT INTO `pby9p_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `pby9p_menu`
--

CREATE TABLE `pby9p_menu` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `pby9p_menu`
--
...
--
-- Структура таблицы `pby9p_menu_types`
--

CREATE TABLE `pby9p_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `pby9p_menu_types`
--

INSERT INTO `pby9p_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `pby9p_messages`
--

CREATE TABLE `pby9p_messages` (
...
--
-- Структура таблицы `pby9p_messages_cfg`
--

CREATE TABLE `pby9p_messages_cfg` (
...
--
-- Структура таблицы `pby9p_modules`
--

CREATE TABLE `pby9p_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Дамп данных таблицы `pby9p_modules`
--
...
--
-- Структура таблицы `pby9p_modules_menu`
--

CREATE TABLE `pby9p_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `pby9p_modules_menu`
--
...
--
-- Структура таблицы `pby9p_newsfeeds`
--

CREATE TABLE `pby9p_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `pby9p_overrider`
--

CREATE TABLE `pby9p_overrider` (
...
--
-- Структура таблицы `pby9p_postinstall_messages`
--

CREATE TABLE `pby9p_postinstall_messages` (
...
--
-- Дамп данных таблицы `pby9p_postinstall_messages`
--
...
--
-- Структура таблицы `pby9p_privacy_consents`
--

CREATE TABLE `pby9p_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `pby9p_privacy_requests`
--

CREATE TABLE `pby9p_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `pby9p_redirect_links`
--

CREATE TABLE `pby9p_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `pby9p_schemas`
--

CREATE TABLE `pby9p_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `pby9p_schemas`
--
...
--
-- Структура таблицы `pby9p_session`
--

CREATE TABLE `pby9p_session` (
...
--
-- Дамп данных таблицы `pby9p_session`
--

INSERT INTO `pby9p_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x3863653837313539343536373933313639393061643133663333646466346537, 1, 1, 1556002916, 'joomla|s:828:\"\";', 0, '');

-- --------------------------------------------------------

--
-- Структура таблицы `pby9p_tags`
--

CREATE TABLE `pby9p_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `pby9p_tags`
--
...
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 734, '2019-04-23 06:33:25', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Структура таблицы `pby9p_template_styles`
--

CREATE TABLE `pby9p_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `pby9p_template_styles`
--
...
--
-- Структура таблицы `pby9p_ucm_base`
--

CREATE TABLE `pby9p_ucm_base` (
...
--
-- Структура таблицы `pby9p_ucm_content`
--

CREATE TABLE `pby9p_ucm_content` (
...
--
-- Структура таблицы `pby9p_ucm_history`
--

CREATE TABLE `pby9p_ucm_history` (
...
--
-- Структура таблицы `pby9p_updates`
--

CREATE TABLE `pby9p_updates` (
...
--
-- Дамп данных таблицы `pby9p_updates`
--
...
(37, 2, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.9.4.1', '', 'https://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
...
(43, 2, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.9.5.1', '', 'https://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
...
(55, 2, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.9.4.1', '', 'https://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
...
--
-- Структура таблицы `pby9p_update_sites`
--

CREATE TABLE `pby9p_update_sites` (
...
--
-- Дамп данных таблицы `pby9p_update_sites`
--

INSERT INTO `pby9p_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1556001733, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1556002893, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1556002893, '');

-- --------------------------------------------------------

--
-- Структура таблицы `pby9p_update_sites_extensions`
--

CREATE TABLE `pby9p_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Дамп данных таблицы `pby9p_update_sites_extensions`
--
...
--
-- Структура таблицы `pby9p_usergroups`
--

CREATE TABLE `pby9p_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `pby9p_usergroups`
--
...
--
-- Структура таблицы `pby9p_users`
--

CREATE TABLE `pby9p_users` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `pby9p_users`
--
...
(734, 'Super User', 'admin', 'alexey.lazarenko@hivext.net', '$2y$10$ZfH7rGKH76mTP2P/UQUtoezkaT5QguV9.JuoBcKzu4RQdQFWYghne', 0, 1, '2019-04-23 06:33:25', '2019-04-23 07:01:56', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `pby9p_user_keys`
--

CREATE TABLE `pby9p_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `pby9p_user_notes`
--

CREATE TABLE `pby9p_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `pby9p_user_profiles`
--

CREATE TABLE `pby9p_user_profiles` (
...
--
-- Структура таблицы `pby9p_user_usergroup_map`
--

CREATE TABLE `pby9p_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `pby9p_user_usergroup_map`
--
...
--
-- Структура таблицы `pby9p_utf8_conversion`
--

CREATE TABLE `pby9p_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `pby9p_utf8_conversion`
--

INSERT INTO `pby9p_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Структура таблицы `pby9p_viewlevels`
--

CREATE TABLE `pby9p_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Дамп данных таблицы `pby9p_viewlevels`
--
...
--
-- Индексы таблицы `pby9p_action_logs`
--
ALTER TABLE `pby9p_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `pby9p_action_logs_extensions`
--
ALTER TABLE `pby9p_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `pby9p_action_logs_users`
--
ALTER TABLE `pby9p_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Индексы таблицы `pby9p_action_log_config`
--
ALTER TABLE `pby9p_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `pby9p_assets`
--
...
--
-- Индексы таблицы `pby9p_associations`
--
...
--
-- Индексы таблицы `pby9p_banner_clients`
--
...
--
-- Индексы таблицы `pby9p_banner_tracks`
--
...
--
-- Индексы таблицы `pby9p_categories`
--
...
--
-- Индексы таблицы `pby9p_contact_details`
--
...
--
-- Индексы таблицы `pby9p_contentitem_tag_map`
--
...
--
-- Индексы таблицы `pby9p_content_frontpage`
--
ALTER TABLE `pby9p_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Индексы таблицы `pby9p_content_rating`
--
ALTER TABLE `pby9p_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Индексы таблицы `pby9p_content_types`
--
...
--
-- Индексы таблицы `pby9p_extensions`
--
...
--
-- Индексы таблицы `pby9p_fields`
--
ALTER TABLE `pby9p_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `pby9p_fields_categories`
--
ALTER TABLE `pby9p_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Индексы таблицы `pby9p_fields_groups`
--
ALTER TABLE `pby9p_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `pby9p_fields_values`
--
ALTER TABLE `pby9p_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Индексы таблицы `pby9p_finder_filters`
--
ALTER TABLE `pby9p_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Индексы таблицы `pby9p_finder_links`
--
...
--
-- Индексы таблицы `pby9p_finder_links_terms0`
--
...
--
-- Индексы таблицы `pby9p_finder_links_terms1`
--
...
--
-- Индексы таблицы `pby9p_finder_links_terms2`
--
...
--
-- Индексы таблицы `pby9p_finder_links_terms3`
--
...
--
-- Индексы таблицы `pby9p_finder_links_terms4`
--
...
--
-- Индексы таблицы `pby9p_finder_links_terms5`
--
...
--
-- Индексы таблицы `pby9p_finder_links_terms6`
--
...
--
-- Индексы таблицы `pby9p_finder_links_terms7`
--
...
--
-- Индексы таблицы `pby9p_finder_links_terms8`
--
...
--
-- Индексы таблицы `pby9p_finder_links_terms9`
--
...
--
-- Индексы таблицы `pby9p_finder_links_termsa`
--
...
--
-- Индексы таблицы `pby9p_finder_links_termsb`
--
...
--
-- Индексы таблицы `pby9p_finder_links_termsc`
--
...
--
-- Индексы таблицы `pby9p_finder_links_termsd`
--
...
--
-- Индексы таблицы `pby9p_finder_links_termse`
--
...
--
-- Индексы таблицы `pby9p_finder_links_termsf`
--
...
--
-- Индексы таблицы `pby9p_finder_taxonomy`
--
...
--
-- Индексы таблицы `pby9p_finder_taxonomy_map`
--
...
--
-- Индексы таблицы `pby9p_finder_terms`
--
...
--
-- Индексы таблицы `pby9p_finder_terms_common`
--
...
--
-- Индексы таблицы `pby9p_finder_tokens`
--
...
--
-- Индексы таблицы `pby9p_finder_tokens_aggregate`
--
...
--
-- Индексы таблицы `pby9p_finder_types`
--
...
--
-- Индексы таблицы `pby9p_languages`
--
...
--
-- Индексы таблицы `pby9p_menu_types`
--
...
--
-- Индексы таблицы `pby9p_messages`
--
...
--
-- Индексы таблицы `pby9p_messages_cfg`
--
ALTER TABLE `pby9p_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Индексы таблицы `pby9p_modules`
--
...
--
-- Индексы таблицы `pby9p_modules_menu`
--
ALTER TABLE `pby9p_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Индексы таблицы `pby9p_newsfeeds`
--
...
--
-- Индексы таблицы `pby9p_overrider`
--
ALTER TABLE `pby9p_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `pby9p_postinstall_messages`
--
ALTER TABLE `pby9p_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Индексы таблицы `pby9p_privacy_consents`
--
ALTER TABLE `pby9p_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Индексы таблицы `pby9p_privacy_requests`
--
ALTER TABLE `pby9p_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `pby9p_redirect_links`
--
...
--
-- Индексы таблицы `pby9p_schemas`
--
ALTER TABLE `pby9p_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Индексы таблицы `pby9p_session`
--
...
--
-- Индексы таблицы `pby9p_template_styles`
--
...
--
-- Индексы таблицы `pby9p_ucm_base`
--
...
--
-- Индексы таблицы `pby9p_ucm_content`
--
...
--
-- Индексы таблицы `pby9p_ucm_history`
--
...
--
-- Индексы таблицы `pby9p_updates`
--
ALTER TABLE `pby9p_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Индексы таблицы `pby9p_update_sites`
--
ALTER TABLE `pby9p_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Индексы таблицы `pby9p_update_sites_extensions`
--
ALTER TABLE `pby9p_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Индексы таблицы `pby9p_usergroups`
--
...
--
-- Индексы таблицы `pby9p_user_keys`
--
...
--
-- Индексы таблицы `pby9p_user_notes`
--
...
--
-- Индексы таблицы `pby9p_user_profiles`
--
ALTER TABLE `pby9p_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Индексы таблицы `pby9p_user_usergroup_map`
--
ALTER TABLE `pby9p_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Индексы таблицы `pby9p_viewlevels`
--
...
--
-- AUTO_INCREMENT для таблицы `pby9p_action_logs`
--
ALTER TABLE `pby9p_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT для таблицы `pby9p_action_logs_extensions`
--
ALTER TABLE `pby9p_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT для таблицы `pby9p_action_log_config`
--
ALTER TABLE `pby9p_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT для таблицы `pby9p_assets`
--
ALTER TABLE `pby9p_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT для таблицы `pby9p_banners`
--
ALTER TABLE `pby9p_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_banner_clients`
--
ALTER TABLE `pby9p_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_categories`
--
ALTER TABLE `pby9p_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT для таблицы `pby9p_contact_details`
--
ALTER TABLE `pby9p_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_content`
--
ALTER TABLE `pby9p_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_content_types`
--
ALTER TABLE `pby9p_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT для таблицы `pby9p_extensions`
--
ALTER TABLE `pby9p_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT для таблицы `pby9p_fields`
--
ALTER TABLE `pby9p_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_fields_groups`
--
ALTER TABLE `pby9p_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_finder_filters`
--
ALTER TABLE `pby9p_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_finder_links`
--
ALTER TABLE `pby9p_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_finder_taxonomy`
--
ALTER TABLE `pby9p_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `pby9p_finder_terms`
--
ALTER TABLE `pby9p_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_finder_types`
--
ALTER TABLE `pby9p_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_languages`
--
ALTER TABLE `pby9p_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `pby9p_menu`
--
ALTER TABLE `pby9p_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT для таблицы `pby9p_menu_types`
--
ALTER TABLE `pby9p_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `pby9p_messages`
--
ALTER TABLE `pby9p_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_modules`
--
ALTER TABLE `pby9p_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT для таблицы `pby9p_newsfeeds`
--
ALTER TABLE `pby9p_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_overrider`
--
ALTER TABLE `pby9p_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT для таблицы `pby9p_postinstall_messages`
--
ALTER TABLE `pby9p_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT для таблицы `pby9p_privacy_consents`
--
ALTER TABLE `pby9p_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_privacy_requests`
--
ALTER TABLE `pby9p_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_redirect_links`
--
ALTER TABLE `pby9p_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_tags`
--
ALTER TABLE `pby9p_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `pby9p_template_styles`
--
ALTER TABLE `pby9p_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT для таблицы `pby9p_ucm_content`
--
ALTER TABLE `pby9p_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_ucm_history`
--
ALTER TABLE `pby9p_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_updates`
--
ALTER TABLE `pby9p_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT для таблицы `pby9p_update_sites`
--
ALTER TABLE `pby9p_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `pby9p_usergroups`
--
ALTER TABLE `pby9p_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT для таблицы `pby9p_users`
--
ALTER TABLE `pby9p_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=735;

--
-- AUTO_INCREMENT для таблицы `pby9p_user_keys`
--
ALTER TABLE `pby9p_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_user_notes`
--
ALTER TABLE `pby9p_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `pby9p_viewlevels`
--
ALTER TABLE `pby9p_viewlevels`
